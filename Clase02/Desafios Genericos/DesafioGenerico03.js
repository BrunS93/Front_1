...
// D) Guardar el objeto info en un archivo llamado info.txt dentro de la misma carpeta de
// package.json
...
// - Consigna B): Para deserializar un string con contenido JSON utilizar JSON.parse
// (convierte string en object).
// - Consigna C): Para serializar un objeto (convertirlo a string) y guardarlo en un archivo
// utilizar JSON.stringify.
// Ayuda:
// Para el Punto 3 considerar usar JSON.stringify(info, null, 2) para preservar el formato de
// representación del objeto en el archivo (2 representa en este caso la cantidad de
