// Desarrollar un motor de plantillas custom para un servidor basado en express,
//  que permita representar en la ruta '/cte1' el siguiente archivo de plantilla 'plantilla1.cte':
